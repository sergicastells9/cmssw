...
config.General.requestName	     =  'MNConversion_2018A_data'
...
config.JobType.psetName          = '2018A_data_cfg.py'
...
config.Data.outLFNDirBase        = '/store/user/castells/outputs/MNConversion_2018A_final/'
