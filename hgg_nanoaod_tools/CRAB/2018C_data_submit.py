...
config.General.requestName	     =  'MNConversion_2018C_data'
...
config.JobType.psetName          = '2018C_data_cfg.py'
...
config.Data.outLFNDirBase        = '/store/user/castells/outputs/MNConversion_2018C_final/'
